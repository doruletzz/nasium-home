...
import { formatDate, getArticlePosts } from "@/app/article/utils";
import { baseUrl } from "@/app/sitemap";
import { Button, CustomMDX } from "@/components";
...
export default function Article({ params }: { params: { slug: string } }) {
  ...
  return (
    <section className="min-h-screen w-full px-4 lg:px-12 md:px-12 sm:px-8 flex items-center pb-24 pt-20 md:pt-36 bg-gray-950">
      <div className="flex gap-12 flex-col sm:flex-row mx-auto">
        <div className="max-w-2xl w-full">
          ...
          />
          <h1 className="title font-display text-2xl tracking-tighter">
            {post.metadata.title}
          </h1>

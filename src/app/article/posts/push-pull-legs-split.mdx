...
1. **Download Nasium**: Head to the Google Play Store and download Nasium ([https://play.google.com/store/apps/details?id=coach.nasium.twa](https://play.google.com/store/apps/details?id=coach.nasium.twa)).
1.1. **Login** (for iOS): Visit [https://nasium.coach/auth/login](https://nasium.coach/auth/login) to login to your Nasium account.
